        ...
        auto eval_dense_fast = [&](const std::vector<DualValue>& yy, std::vector<DualValue>* subgradient) -> DualValue {
            ...
            for (std::size_t li = 0; li < compact_line_ids.size(); ++li) {
                ...
                switch (end - begin) {
                    case 3:
                        sum_y =
                            yy_data[compact_point_aps_data[begin]] +
                            yy_data[compact_point_aps_data[begin + 1]] +
                            yy_data[compact_point_aps_data[begin + 2]];
                        break;
                    case 4:
                        sum_y =
                            yy_data[compact_point_aps_data[begin]] +
                            yy_data[compact_point_aps_data[begin + 1]] +
                            yy_data[compact_point_aps_data[begin + 2]] +
                            yy_data[compact_point_aps_data[begin + 3]];
                        break;
                    case 5:
                        sum_y =
                            yy_data[compact_point_aps_data[begin]] +
                            ...
                            yy_data[compact_point_aps_data[begin + 2]] +
                            yy_data[compact_point_aps_data[begin + 3]] +
                            yy_data[compact_point_aps_data[begin + 4]];
                        break;
                    default:
                ...
                if (rc > 1e-18) {
                    ...
                    if (subgradient_data) {
                        switch (end - begin) {
                            case 3:
                                subgradient_data[compact_point_aps_data[begin]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 1]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 2]] -= 1.0;
                                break;
                            case 4:
                                subgradient_data[compact_point_aps_data[begin]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 1]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 2]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 3]] -= 1.0;
                                break;
                            case 5:
                                subgradient_data[compact_point_aps_data[begin]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 1]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 2]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 3]] -= 1.0;
                                subgradient_data[compact_point_aps_data[begin + 4]] -= 1.0;
                                break;
                            default:
                                for (std::size_t pos = begin; pos < end; ++pos)
