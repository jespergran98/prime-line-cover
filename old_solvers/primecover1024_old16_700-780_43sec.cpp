...
constexpr int    kExecutionLimit       = 780;   // hard cap and default run-to N
// Maximum wall-clock seconds allowed per N. Set to 0.0 to disable (no limit). 60=1 min
constexpr double kPerNTimeLimitSeconds = 10;
...
private:
        ...
        int* greedy_gain_out) const
    {
        ...
        const int greedy_lb = greedy_completion(task, ctx, keep_greedy_lines);
