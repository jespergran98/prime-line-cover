    ...
    const std::vector<int>& chosen_heavy_line_ids)
{
    ...
    witness.heavy_line_ids = chosen_heavy_line_ids;
...
int main(int argc, char** argv) {
    ...
    std::cout << '\n'
              ...
              << "  lb=     — The certified lower bound before branching; on witness hits this comes directly from the carried-over exact cover.\n"
              ...
              << "  lb_raw= — The raw certified lower bound before the monotonic floor; on witness hits this is the carried-over exact value.\n"
